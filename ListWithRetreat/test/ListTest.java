...
public abstract class ListTest {
    ...
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "orange",
                "yellow");
        List<String> list2 = this.createFromArgsRef(2, "red", "orange",
                "yellow");
        /*
         * Call method under test
         */
    ...
    public final void testRetreatLeftNonEmptyRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "blue", "green",
                "yellow", "purple");
        List<String> list2 = this.createFromArgsRef(2, "red", "blue", "green",
                "yellow", "purple");
        /*
         * Call method under test
         */
