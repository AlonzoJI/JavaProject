...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node q = new Node();
        this.lastLeft.next = q;
        q.previous = this.lastLeft;
        q.data = x;
        q.next = p;
        p.previous = q;
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        this.rightLength--;
        Node beingRemoved = this.lastLeft.next;
        this.lastLeft.next = beingRemoved.next;
        this.lastLeft.next.previous = this.lastLeft;
        T beingRemovedData = beingRemoved.data;

        assert this.conventionHolds();
        return beingRemovedData;
    }
